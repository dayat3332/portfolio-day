...
export default function Profile() {
  ...
  >
    Hello everyone <span className="font-bold">I'm Diding Hidayat</span>. 
    a graduate <span className="font-bold">SMK 1 Lelea</span>.
    <br />
    <span className="font-regular italic text-sm">"My skills are in the fields of networking, graphic designer, UI/UX Design, front end, and Microsoft Office"</span>
  </motion.p>
  ...
  >
    ...
    {/* GitHub */}
    <a
      href="https://github.com/dayat3332"
      target="_blank"
    >
      <FaGithub />
    </a>
    ...
    {/* LinkedIn */}
    <a
      href="https://www.linkedin.com/in/diding-hidayat-263a21327/"
      target="_blank"
    >
      <FaLinkedin />
    </a>
...
<ScrollVelocity
  texts={['UI/UX Designer', 'Front End', 'Networking']}
  velocity={10}
